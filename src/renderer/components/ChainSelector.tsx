...
const ChainSelector: FC = () => {
  ...
  const items: MenuProps['items'] = useMemo(
    () => [
      ...
      {
        label: 'Arbitrum',
        key: chainIds.arbitrum,
        icon: labelToShow(arbitrum_Logo, 'Arbitrum_Logo'),
      },
      {
      ...
      },
      {
        label: 'zkSync Era',
        key: chainIds.zkSync,
        icon: labelToShow(zksync_Logo, 'zksync_Logo'),
      },
      {
        label: 'zkSync testnet',
        key: chainIds.zksynctest,
        icon: labelToShow(zksync_Logo, 'zksync_Logo'),
      },
      {
        label: 'Polygon',
        key: chainIds.polygon,
        icon: labelToShow(polygon_logo, 'Polygon_logo'),
      },
      {
        label: 'Mumbai',
        key: chainIds.mumbai,
      ...
      },
      {
        label: 'Fantom',
        key: chainIds.fantom,
        icon: labelToShow(fantom_Logo, 'Fantom_Logo'),
      },
      {
        label: 'Fantom testnet',
        key: chainIds.fantomtest,
        icon: labelToShow(fantom_Logo, 'Fantom_Logo'),
      },
      {
        label: 'BNB Chain',
